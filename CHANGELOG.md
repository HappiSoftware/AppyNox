...
## [1.15.0](https://github.com/HappiSoftware/AppyNox/compare/v1.14.0...v1.15.0) - NOT RELEASED


## [1.14.0](https://github.com/HappiSoftware/AppyNox/compare/v1.13.0...v1.14.0) - 2024.08.01
### Added
- TotalCount in PaginatedList in the Nox MediatR responses are working with provided query filters now.
- appsetting.json, appsettings.Development.json files are not ignored now.
- C.I. pipeline problems resolved.
- Feature request: Nox MediatR Commands Should Allow Extensions ([#331](https://github.com/HappiSoftware/AppyNox/issues/331))
...
### Improved
- Refactoring request: Version Update and Warning Resolving ([#316](https://github.com/HappiSoftware/AppyNox/issues/316))

### Fixed
- Bug report: AppyNox C.I.'s are failing ([#308](https://github.com/HappiSoftware/AppyNox/issues/308))
- Bug report: Nox Repository Filters Returning "Malicious behavior detected." ([#310](https://github.com/HappiSoftware/AppyNox/issues/310))
- Bug report: Anemic Repository Update Method Is Deleting Values ([#313](https://github.com/HappiSoftware/AppyNox/issues/313))
