...
/// </summary>
public class LoggingMiddleware(RequestDelegate next, INoxApiLogger<LoggingMiddleware> logger)
{
    #region [ Fields ]

    private readonly RequestDelegate _next = next;

    private readonly INoxApiLogger<LoggingMiddleware> _logger = logger;
