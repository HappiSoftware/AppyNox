...
public record GetAllNoxEntitiesQuery<TEntity, TDto>(IQueryParameters QueryParameters, NoxCommandExtensions Extensions = default!) 
    : IRequest<PaginatedList<TDto>>, IHaveNoxCommandExtensions
    where TEntity : class, IHasStronglyTypedId;

[SuppressMessage("Sonar Code Smell", "S2326:Unused type parameters should be removed", Justification = "TEntity is used to specify the type of entity being created")]
public record GetNoxEntityByIdQuery<TEntity, TId, TDto>(TId Id, IQueryParameters QueryParameters, bool Track = false, NoxCommandExtensions Extensions = default!) 
    : IRequest<TDto>, IHaveNoxCommandExtensions
    where TEntity : class, IHasStronglyTypedId
    where TId : NoxId;

[SuppressMessage("Sonar Code Smell", "S2326:Unused type parameters should be removed", Justification = "TEntity is used to specify the type of entity being created")]
public record CreateNoxEntityCommand<TEntity, TDto>(TDto Dto, NoxCommandExtensions Extensions = default!) 
