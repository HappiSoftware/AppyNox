...
namespace AppyNox.Services.Authentication.Infrastructure.ExceptionExtensions.Base
{
    ...
    internal class NoxSsoInfrastructureException : NoxInfrastructureException, INoxInfrastructureException
    {
        #region [ Fields ]
        ...
        /// <param name="exceptionCode">The code of the exception.</param>
        /// <param name="message">The message that describes the error.</param>
        public NoxSsoInfrastructureException(Exception ex, int exceptionCode, string message = "Unexpected error")
        ...
        /// <param name="exceptionCode">The code of the exception.</param>
        /// <param name="statusCode">The HTTP status code associated with the exception.</param>
        public NoxSsoInfrastructureException(Exception ex, string message, int exceptionCode, int statusCode)
