...
namespace AppyNox.Services.Coupon.Infrastructure.Migrations
{
    ...
    [Migration("20240228121608_AddTicketAndTicketTag")]
    partial class AddTicketAndTicketTag
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AppyNox.Services.Coupon.Domain.Entities.Ticket", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ReportDate = new DateTime(2024, 2, 28, 12, 16, 7, 834, DateTimeKind.Utc).AddTicks(4727),
                            Title = "Title"
                        });
                });
                    ...
                    b.OwnsOne("AppyNox.Services.Base.Domain.Interfaces.NoxAuditData", "Audit", b1 =>
                        {
                            ...
                            b1.HasData(
                                new
                                {
                                    CouponId = new Guid("594cf045-3a2b-46f5-99c9-1eb59f035db2"),
                                    CreatedBy = "admin",
                                    CreationDate = new DateTime(2024, 2, 28, 12, 16, 7, 818, DateTimeKind.Utc).AddTicks(2044),
                                    UpdatedBy = ""
                                },
                                new
                                {
                                    CouponId = new Guid("c386aec2-dfd2-4ea5-b878-8fe5632e2e40"),
                                    CreatedBy = "admin",
                                    CreationDate = new DateTime(2024, 2, 28, 12, 16, 7, 818, DateTimeKind.Utc).AddTicks(2271),
                                    UpdatedBy = ""
                                });
                        });
                    ...
                    b.OwnsOne("AppyNox.Services.Base.Domain.Interfaces.NoxAuditData", "Audit", b1 =>
                        {
                            ...
                            b1.HasData(
                                new
                                {
                                    CouponDetailId = new Guid("ec80532f-58f0-4690-b40c-2133b067d5f2"),
                                    CreatedBy = "admin",
                                    CreationDate = new DateTime(2024, 2, 28, 12, 16, 7, 827, DateTimeKind.Utc).AddTicks(9211),
                                    UpdatedBy = ""
                                });
                        });
                    ...
                    b.OwnsOne("AppyNox.Services.Base.Domain.Interfaces.NoxAuditData", "Audit", b1 =>
                        {
                            ...
                            b1.HasData(
                                new
                                {
                                    ...
                                    CreatedBy = "admin",
                                    CreationDate = new DateTime(2024, 2, 28, 12, 16, 7, 834, DateTimeKind.Utc).AddTicks(1262),
                                    UpdatedBy = ""
                                });
                        });
