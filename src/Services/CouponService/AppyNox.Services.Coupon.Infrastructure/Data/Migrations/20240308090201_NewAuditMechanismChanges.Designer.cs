...
namespace AppyNox.Services.Coupon.Infrastructure.Migrations
{
    ...
    [Migration("20240308090201_NewAuditMechanismChanges")]
            ...
            modelBuilder.Entity("AppyNox.Services.Coupon.Domain.Coupons.Coupon", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "System",
                            CreationDate = new DateTime(2024, 3, 8, 9, 2, 0, 335, DateTimeKind.Utc).AddTicks(1598),
                        ...
                        new
                        {
                            ...
                            CouponDetailId = new Guid("ec80532f-58f0-4690-b40c-2133b067d5f2"),
                            CreatedBy = "System",
                            CreationDate = new DateTime(2024, 3, 8, 9, 2, 0, 335, DateTimeKind.Utc).AddTicks(1813),
            ...
            modelBuilder.Entity("AppyNox.Services.Coupon.Domain.Coupons.CouponDetail", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Code = "EXD10",
                            CreatedBy = "System",
                            CreationDate = new DateTime(2024, 3, 8, 9, 2, 0, 336, DateTimeKind.Utc).AddTicks(1596),
                            Detail = "TestDetail"
                        });
                });
            ...
            modelBuilder.Entity("AppyNox.Services.Coupon.Domain.Coupons.CouponDetailTag", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CouponDetailId = new Guid("ec80532f-58f0-4690-b40c-2133b067d5f2"),
                            CreatedBy = "System",
                            CreationDate = new DateTime(2024, 3, 8, 9, 2, 0, 337, DateTimeKind.Utc).AddTicks(7507),
                            Tag = "Tag Description"
                        });
                });
            ...
            modelBuilder.Entity("AppyNox.Services.Coupon.Domain.Entities.Ticket", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "system",
                            CreationDate = new DateTime(2024, 3, 8, 9, 2, 0, 337, DateTimeKind.Utc).AddTicks(9278),
                            ReportDate = new DateTime(2024, 3, 8, 9, 2, 0, 337, DateTimeKind.Utc).AddTicks(9278),
                            Title = "Title"
                        });
                });
