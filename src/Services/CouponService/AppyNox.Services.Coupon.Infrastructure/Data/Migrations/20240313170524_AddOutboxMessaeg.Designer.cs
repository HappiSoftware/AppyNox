...
namespace AppyNox.Services.Coupon.Infrastructure.Migrations
{
    ...
    [Migration("20240313170524_AddOutboxMessaeg")]
    partial class AddOutboxMessaeg
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AppyNox.Services.Coupon.Domain.Coupons.Coupon", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "System",
                            CreationDate = new DateTime(2024, 3, 13, 17, 5, 24, 40, DateTimeKind.Utc).AddTicks(2624),
                        ...
                        new
                        {
                            ...
                            CouponDetailId = new Guid("ec80532f-58f0-4690-b40c-2133b067d5f2"),
                            CreatedBy = "System",
                            CreationDate = new DateTime(2024, 3, 13, 17, 5, 24, 40, DateTimeKind.Utc).AddTicks(3113),
            ...
            modelBuilder.Entity("AppyNox.Services.Coupon.Domain.Coupons.CouponDetail", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Code = "EXD10",
                            CreatedBy = "System",
                            CreationDate = new DateTime(2024, 3, 13, 17, 5, 24, 41, DateTimeKind.Utc).AddTicks(5964),
                            Detail = "TestDetail"
                        });
                });
            ...
            modelBuilder.Entity("AppyNox.Services.Coupon.Domain.Coupons.CouponDetailTag", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CouponDetailId = new Guid("ec80532f-58f0-4690-b40c-2133b067d5f2"),
                            CreatedBy = "System",
                            CreationDate = new DateTime(2024, 3, 13, 17, 5, 24, 43, DateTimeKind.Utc).AddTicks(5123),
                            Tag = "Tag Description"
                        });
                });
            ...
            modelBuilder.Entity("AppyNox.Services.Coupon.Domain.Coupons.CouponHistory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f5a9014c-88c9-44ab-983c-81191d73b271"),
                            CouponId = new Guid("594cf045-3a2b-46f5-99c9-1eb59f035db2"),
                            CreatedBy = "System",
                            CreationDate = new DateTime(2024, 3, 13, 17, 5, 24, 44, DateTimeKind.Utc).AddTicks(3304),
                            Date = new DateTime(2024, 3, 13, 17, 5, 24, 44, DateTimeKind.Utc).AddTicks(3303),
                            MinimumAmount = 100
                        });
                });
            ...
            modelBuilder.Entity("AppyNox.Services.Coupon.Domain.Entities.Ticket", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "System",
                            CreationDate = new DateTime(2024, 3, 13, 17, 5, 24, 43, DateTimeKind.Utc).AddTicks(7408),
                            ReportDate = new DateTime(2024, 3, 13, 17, 5, 24, 43, DateTimeKind.Utc).AddTicks(7407),
                            Title = "Title"
                        });
                });
