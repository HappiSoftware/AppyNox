...
namespace AppyNox.Services.Coupon.Infrastructure.Migrations
{
    ...
    [Migration("20240319132644_AddTicketToTicketTag")]
    partial class AddTicketToTicketTag
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AppyNox.Services.Coupon.Domain.Coupons.Coupon", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "System",
                            CreationDate = new DateTime(2024, 3, 19, 13, 26, 42, 439, DateTimeKind.Utc).AddTicks(3841),
                        ...
                        new
                        {
                            ...
                            CouponDetailId = new Guid("ec80532f-58f0-4690-b40c-2133b067d5f2"),
                            CreatedBy = "System",
                            CreationDate = new DateTime(2024, 3, 19, 13, 26, 42, 439, DateTimeKind.Utc).AddTicks(4112),
            ...
            modelBuilder.Entity("AppyNox.Services.Coupon.Domain.Coupons.CouponDetail", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Code = "EXD10",
                            CreatedBy = "System",
                            CreationDate = new DateTime(2024, 3, 19, 13, 26, 42, 440, DateTimeKind.Utc).AddTicks(3760),
                            Detail = "TestDetail"
                        });
                });
            ...
            modelBuilder.Entity("AppyNox.Services.Coupon.Domain.Coupons.CouponDetailTag", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CouponDetailId = new Guid("ec80532f-58f0-4690-b40c-2133b067d5f2"),
                            CreatedBy = "System",
                            CreationDate = new DateTime(2024, 3, 19, 13, 26, 42, 442, DateTimeKind.Utc).AddTicks(1305),
                            Tag = "Tag Description"
                        });
                });
            ...
            modelBuilder.Entity("AppyNox.Services.Coupon.Domain.Coupons.CouponHistory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ab671c84-7bb8-4ba1-a60f-1e4442b25683"),
                            CouponId = new Guid("594cf045-3a2b-46f5-99c9-1eb59f035db2"),
                            CreatedBy = "System",
                            CreationDate = new DateTime(2024, 3, 19, 13, 26, 42, 443, DateTimeKind.Utc).AddTicks(5360),
                            Date = new DateTime(2024, 3, 19, 13, 26, 42, 443, DateTimeKind.Utc).AddTicks(5357),
                            MinimumAmount = 100
                        });
                });
            ...
            modelBuilder.Entity("AppyNox.Services.Coupon.Domain.Entities.Ticket", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "System",
                            CreationDate = new DateTime(2024, 3, 19, 13, 26, 42, 442, DateTimeKind.Utc).AddTicks(5409),
                            ReportDate = new DateTime(2024, 3, 19, 13, 26, 42, 442, DateTimeKind.Utc).AddTicks(5407),
                            Title = "Title"
                        });
                });
