...
namespace AppyNox.Services.License.Infrastructure.Migrations
{
    ...
    [Migration("20240221020518_EntityBaseToLicenseAndProduct")]
    partial class EntityBaseToLicenseAndProduct
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AppyNox.Services.License.Domain.Entities.LicenseEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ExpirationDate = new DateTime(2025, 2, 20, 2, 5, 18, 161, DateTimeKind.Utc).AddTicks(1799),
