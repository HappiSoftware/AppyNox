...
namespace AppyNox.Services.Sso.Infrastructure.Migrations
{
    ...
    [Migration("20240328110204_AddEmailProvider")]
    partial class AddEmailProvider
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AppyNox.Services.Sso.Domain.Entities.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Code = "USR01",
                            CompanyId = new Guid("221e8b2c-59d5-4e5b-b010-86c239b66738"),
                            ConcurrencyStamp = "b349e81b-dcd0-4774-875d-2f82f354b851",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAECctZAT6KwHXJS1xZlAYsc5DxH2BsB4/YjiKxn27mZkHg06+TwX/FHFAaZOEkW2GIQ==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "9d5ace69-894a-4b66-beb8-0d187a2362a2",
                        ...
                        new
                        {
                            ...
                            Code = "USR02",
                            CompanyId = new Guid("0ebae1bf-6610-4967-a8ed-b149219caf68"),
                            ConcurrencyStamp = "31e68687-35e0-4534-b2cc-2fb863eced6a",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEJjVQWt956MazyDYrfrW69EMs/tf3WJVePShA99G24/U10AAByIvJ1zAWd+i7nDDxQ==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "d48aea4c-df26-4f51-9130-48f91a715bc9",
                            TwoFactorEnabled = false,
                            UserName = "superadmin"
                        });
                });
            ...
            modelBuilder.Entity("AppyNox.Services.Sso.Domain.Entities.EmailProvider", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("AppyNox.Services.Sso.Domain.Entities.EmailProvider", b =>
                {
                    b.HasOne("AppyNox.Services.Sso.Domain.Entities.Company", null)
