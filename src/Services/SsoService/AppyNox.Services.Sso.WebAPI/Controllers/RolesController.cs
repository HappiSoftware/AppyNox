        ...
        : ControllerBase
{
    ...
    public async Task<IActionResult> GetById(Guid id)
    {
        var identityRole = await _roleManager.FindByIdAsync(id.ToString())
            ?? throw new NoxSsoApiException("Not Found", statusCode: (int)HttpStatusCode.NotFound);
    ...
    public async Task<IActionResult> Post(ApplicationRoleCreateDto identityRoleDto)
    {
        ...
        {
            throw new NoxFluentValidationException(typeof(ApplicationRoleCreateDto), fluentValidationResult);
        }
